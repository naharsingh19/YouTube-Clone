...
import playTube from "../assets/yt-logo.png";
import playTubeMobile from "../assets/yt-logo-mobile.png";
    ...
    <div className="flex flex-row h-14 px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <Link to={"https://github.com/naharsingh19"}>
            <img
              src="https://avatars.githubusercontent.com/u/78068436?u=1d6d86ef8aa99158e01ec239a93a084484380b27&v=4"
              alt="Codophile"
            />
          </Link>
        </div>
